...
def update_api_descuento(id):
    try:
        ...
        cantidad = int(descuento["cantidad"]) if str(descuento["cantidad"]).isdigit() else descuento["cantidad"]
        nombre = descuento["nombre"]
        fecha_aplicacion = descuento["fecha_aplicacion"]
        porcentaje = int(descuento["cantidad"]) if str(descuento["cantidad"]).isdigit() else descuento["cantidad"]
...
def create_api_descuento():
    try:
        ...
        cantidad = int(descuento["cantidad"]) if str(descuento["cantidad"]).isdigit() else descuento["cantidad"]
        fecha_aplicacion = descuento["fecha_aplicacion"]
        porcentaje = int(descuento["porcentaje"]) if str(descuento["porcentaje"]).isdigit() else descuento["porcentaje"]
